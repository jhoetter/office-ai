...
| `customXml/*` (top-level)                           | `XlsxWorkbook.opaqueParts`                                         |         no         | Top-level custom XML (SharePoint metadata, content type bindings). Opaque.                                                                                   |
...
| `xl/customXml/*`, `customXml/*`                                             | Custom XML data binding (SharePoint, content-type metadata). Out of scope.                       |
