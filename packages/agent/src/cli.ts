...
function registerSessionSubcommands(sessions: Command, io: IO): void {
  sessions
    .command("create")
...
export async function runCli(argv: string[], io: IO = defaultIO): Promise<number> {
  ...
  const sessions = program
    .command("sessions")
    .description("Manage local OfficeAI sessions, documents, projections, exports and store maintenance.");
  registerSessionSubcommands(sessions, io);
