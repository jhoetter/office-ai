...
const PNG_OTHER = new Uint8Array([
  0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a, 0x00, 0x00, 0x00, 0x0d, 0x49, 0x48, 0x44, 0x52,
  0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x08, 0x06, 0x00, 0x00, 0x00, 0x1f, 0x15, 0xc4,
  0x89, 0x00, 0x00, 0x00, 0x10, 0x49, 0x44, 0x41, 0x54, 0x78, 0x9c, 0x62, 0xfc, 0xff, 0xff, 0x3f,
  0x03, 0x21, 0x00, 0x00, 0x09, 0xfb, 0x03, 0xfd, 0x18, 0xf3, 0xb8, 0xa9, 0x00, 0x00, 0x00, 0x00,
...
describe("P1: insert-image", () => {
  ...
  it("dedups identical bytes via SHA-256 (same media path used twice)", async () => {
    ...
    const pics = agent
      .getSnapshot()
      .root.slides[0].shapes.filter((s): s is Picture => s.kind === "pic");
