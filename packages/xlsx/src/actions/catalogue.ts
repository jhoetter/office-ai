...
export const xlsxActions: ReadonlyArray<ActionDescriptor> = [
  ...
  },
  {
    ...
    description:
      "Apply a format patch to a range (font/fill/border/alignment/numberFormat). Pass --format as JSON.",
    section: "Format",
    surfaces: ["cli", "palette"],
    args: [
      {
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: "A1 cell or range, e.g. A1 or A1:E5",
      },
      {
        name: "format",
        flag: "--format <json>",
        kind: "string",
        required: true,
        description: "JSON CellFormatPatch (font/fill/border/alignment/numberFormat)",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Toggle wrap-text on a range. Wrapped cells display long content on multiple lines instead of overflowing.",
    section: "Format",
    ...
    args: [
      ...
      },
      {
        ...
        kind: "boolean",
        default: true,
        description: "true to enable, false to disable wrapping",
      },
    ],
  ...
  // ── Rows / columns / merges ───────────────────────────────────────
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "number",
        required: true,
        description: "1-based row index — insertion happens BEFORE this row",
      },
      {
        name: "count",
        flag: "--count <n>",
        kind: "number",
        default: 1,
        description: "Number of blank rows to insert",
      },
    ],
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "number",
        required: true,
        description: "1-based column index (A=1)",
      },
      {
        name: "count",
        flag: "--count <n>",
        kind: "number",
        default: 1,
        description: "Number of blank columns to insert",
      },
    ],
    buildPayload: ({ sheet, at, count }) => ({
      sheet: String(sheet),
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "number",
        required: true,
        description: "1-based row index of the first row to drop",
      },
      {
        name: "count",
        flag: "--count <n>",
        kind: "number",
        default: 1,
        description: "Number of rows to drop",
      },
    ],
    buildPayload: ({ sheet, at, count }) => ({
      sheet: String(sheet),
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "number",
        default: 1,
        description: "Number of columns to drop",
      },
    ],
    buildPayload: ({ sheet, at, count }) => ({
      sheet: String(sheet),
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: "A1 range, e.g. A1:B2",
      },
    ],
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: "A1 range matching an existing merge exactly",
      },
    ],
    buildPayload: ({ sheet, range }) => ({ sheet: String(sheet), range: String(range) }),
  },
  ...
  },
  {
    ...
    args: [
      ...
      { name: "row", flag: "--row <n>", kind: "number", required: true, description: "1-based row index" },
      {
        ...
        kind: "boolean",
        required: true,
        description: "true = hide, false = show",
      },
    ],
  ...
  // ── Conditional formatting / validation / defined names ───────────
  {
    ...
    description:
      "Add a conditional formatting rule to a range. Pass --rule as JSON matching the ConditionalFormat schema.",
    section: "Format",
    surfaces: ["cli", "palette"],
    args: [
      {
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: "JSON ConditionalFormat (id, range, type, …) — see model/types.ts",
      },
    ],
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: "Rule id (returned by add-conditional-format)",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Add a data validation rule to a range. Pass --rule as JSON matching the DataValidation schema.",
    section: "Data",
    surfaces: ["cli", "palette"],
    args: [
      {
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: "JSON DataValidation (id, range, type, …)",
      },
    ],
    buildPayload: ({ sheet, rule }) => ({
      sheet: String(sheet),
    ...
    args: [
      {
        ...
        kind: "string",
        required: true,
        description: "Display name (no spaces, ≤ 255 chars, not a cell ref)",
      },
      {
        name: "refersTo",
        flag: "--refers-to <expr>",
        kind: "string",
        required: true,
        description: 'OOXML refersTo expression without leading = (e.g. "Sheet1!$A$1:$B$5")',
      },
      {
        name: "scope",
        flag: "--scope <sheet>",
        kind: "string",
        description: "Sheet-name scope (omit for workbook-scoped)",
      },
    ...
    args: [
      {
        ...
        kind: "string",
        required: true,
        description: "Existing name to update",
      },
      {
        name: "scope",
        flag: "--scope <sheet>",
        kind: "string",
        description: "Existing scope (omit for workbook-scoped)",
      },
      { name: "nextName", flag: "--next-name <name>", kind: "string", description: "New name (rename)" },
      {
        ...
        flag: "--refers-to <expr>",
        kind: "string",
        description: "New refersTo expression",
      },
  ...
  },
  {
    ...
    args: [
      { name: "name", flag: "--name <name>", kind: "string", required: true, description: "Name to delete" },
      {
        ...
        flag: "--scope <sheet>",
        kind: "string",
        description: "Scope (omit for workbook-scoped)",
      },
    ],
  ...
  // ── Tables / charts / images ──────────────────────────────────────
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: 'A1 range covering header + body, e.g. "A1:E25"',
      },
      {
        name: "hasHeaders",
        flag: "--has-headers <bool>",
        kind: "boolean",
        default: true,
        description: "Whether the first row is the header (default true)",
      },
    ...
    buildPayload: ({ sheet, range, hasHeaders, name }) => ({
      ...
      ...(hasHeaders !== undefined
        ? { hasHeaders: hasHeaders === false || hasHeaders === "false" ? false : true }
        : {}),
  ...
  },
  {
    ...
    args: [
      ...
      { name: "chartId", flag: "--chart-id <id>", kind: "string", required: true, description: "Chart id" },
      {
        ...
        kind: "number",
        required: true,
        description: "Anchor cell row (0-based)",
      },
      {
        name: "fromCol",
        flag: "--from-col <n>",
        kind: "number",
        required: true,
        description: "Anchor cell column (0-based)",
      },
      {
        name: "fromOffsetXPx",
        flag: "--from-offset-x <px>",
        kind: "number",
        default: 0,
        description: "X offset within the anchor cell, in CSS pixels",
      },
      {
        name: "fromOffsetYPx",
        flag: "--from-offset-y <px>",
        kind: "number",
        default: 0,
        description: "Y offset within the anchor cell, in CSS pixels",
      },
    ],
  ...
  },
  {
    ...
    args: [
      ...
      { name: "chartId", flag: "--chart-id <id>", kind: "string", required: true, description: "Chart id" },
      {
        ...
        flag: "--kind <type>",
        kind: "enum",
        choices: ["bar", "column", "line", "pie", "area"],
      ...
      },
      {
        ...
        flag: "--data-range <a1>",
        kind: "string",
        description: "A1 data range (≥ 2 cells)",
      },
      {
        name: "title",
        flag: "--title <text|null>",
        kind: "string",
        description: 'Chart title; pass "null" to clear',
      },
      {
        name: "hasHeaderRow",
        flag: "--has-header-row <bool>",
        kind: "boolean",
        description: "Whether the first row is the header",
      },
      {
        name: "hasCategoryColumn",
        flag: "--has-category-column <bool>",
        kind: "boolean",
        description: "Whether the first column is the category",
      },
    ],
    buildPayload: ({ sheet, chartId, kind, dataRange, title, hasHeaderRow, hasCategoryColumn }) => ({
      ...
      ...(hasHeaderRow !== undefined
        ? { hasHeaderRow: hasHeaderRow === false || hasHeaderRow === "false" ? false : true }
        : {}),
      ...(hasCategoryColumn !== undefined
        ? { hasCategoryColumn: hasCategoryColumn === false || hasCategoryColumn === "false" ? false : true }
        : {}),
    }),
  },
  {
  ...
  // ── Auto-filter / sort / paste / fill / freeze / split ────────────
  {
    ...
    args: [
      ...
      },
      {
        ...
        flag: "--range <a1|null>",
        kind: "string",
        description: 'A1 range covering header + body, e.g. "A1:E100", or "null" to remove',
      },
    ],
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "number",
        required: true,
        description: "0-based offset from autoFilter.range.c1",
      },
      {
        name: "criterion",
        flag: "--criterion <json>",
        kind: "string",
        required: true,
        description: "JSON FilterColumn (e.g. {kind:'values',values:['A','B']})",
      },
    ],
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: 'A1 range; the first row is treated as the header (e.g. "A1:E25")',
      },
      {
        name: "colId",
        flag: "--col-id <n>",
        kind: "number",
        required: true,
        description: "0-based column offset from the range's first column",
      },
      {
        name: "order",
        flag: "--order <asc|desc>",
  ...
  },
  {
    ...
    args: [
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Comma-separated 0-based column offsets to compare (default: all columns)",
      },
    ],
  ...
  // ── Phase 6 — Protection ─────────────────────────────────────────
  {
    ...
    args: [
      ...
      },
      {
        ...
        flag: "--hash-value <hex>",
        kind: "string",
        description: "Hash value (algorithm output).",
      },
      ...
      {
        name: "autoFilter",
        flag: "--auto-filter <bool>",
        kind: "boolean",
        description: "Allow using AutoFilter.",
      },
      {
        name: "pivotTables",
        flag: "--pivot-tables <bool>",
        kind: "boolean",
        description: "Allow editing pivot tables.",
      },
      {
        name: "selectUnlockedCells",
        flag: "--select-unlocked-cells <bool>",
        kind: "boolean",
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: "lockStructure",
        flag: "--lock-structure <bool>",
        kind: "boolean",
        description: "Lock workbook structure.",
      },
      {
        name: "lockWindows",
        flag: "--lock-windows <bool>",
        kind: "boolean",
        description: "Lock workbook windows.",
      },
      {
        name: "lockRevision",
        flag: "--lock-revision <bool>",
        kind: "boolean",
        description: "Lock revision tracking.",
      },
    ],
    buildPayload: (parsed) => {
      const out: Record<string, unknown> = {
  ...
  // ── Phase 4c — Formulas tab ──────────────────────────────────────
  {
    ...
    args: [
      ...
      {
        name: "calcOnSave",
        flag: "--calc-on-save <bool>",
        kind: "boolean",
        description: "Recalculate before saving.",
      },
      {
        name: "iterate",
        flag: "--iterate <bool>",
        kind: "boolean",
        description: "Enable iterative calculation.",
      },
      {
        name: "iterateCount",
        flag: "--iterate-count <n>",
        kind: "number",
        description: "Maximum iterations.",
      },
      {
        name: "iterateDelta",
        flag: "--iterate-delta <n>",
        kind: "number",
        description: "Convergence delta.",
      },
    ],
    buildPayload: (parsed) => {
      const out: Record<string, unknown> = {};
      if (parsed.calcMode) out.calcMode = String(parsed.calcMode);
      if (parsed.calcOnSave !== undefined)
        out.calcOnSave = parsed.calcOnSave !== false && parsed.calcOnSave !== "false";
  ...
  },
  {
    ...
    args: [
      { name: "sheet", flag: "--sheet <name>", kind: "string", required: true, description: "Sheet name." },
      {
        ...
        kind: "boolean",
        default: true,
        description: "true to show formulas, false to show values.",
      },
    ],
  ...
  // ── Phase 4b: Page Layout ──────────────────────────────────────────
  {
    ...
    args: [
      ...
      },
      {
        ...
        flag: "--paper-size <n>",
        kind: "number",
        description: "OOXML paperSize enum (1=letter, 9=A4).",
      },
      {
        name: "scale",
        flag: "--scale <n>",
        kind: "number",
        description: "Print scaling percentage (10–400).",
      },
      {
        name: "fitToWidth",
        flag: "--fit-to-width <n>",
        kind: "number",
        description: "Pages wide; 0 = use scale.",
      },
      {
        name: "fitToHeight",
        flag: "--fit-to-height <n>",
        kind: "number",
        description: "Pages tall; 0 = use scale.",
      },
      {
        name: "firstPageNumber",
        flag: "--first-page-number <n>",
        kind: "number",
        description: "First page number.",
      },
      {
        name: "useFirstPageNumber",
        flag: "--use-first-page-number <bool>",
        kind: "boolean",
        description: "Honour firstPageNumber.",
      },
      {
        name: "blackAndWhite",
        flag: "--black-and-white <bool>",
        kind: "boolean",
        description: "Print in B&W.",
      },
      {
        name: "draft",
        flag: "--draft <bool>",
        kind: "boolean",
        description: "Draft quality (skip graphics).",
      },
      {
        name: "clear",
        flag: "--clear",
        kind: "boolean",
        description: "Drop the <pageSetup> element entirely.",
      },
    ],
    buildPayload: (a) => {
  ...
  },
  {
    ...
    args: [
      ...
      { name: "footerIn", flag: "--footer-in <n>", kind: "number", description: "Footer margin (inches)." },
      {
        ...
        flag: "--clear",
        kind: "boolean",
        description: "Drop the <pageMargins> element entirely.",
      },
    ],
    buildPayload: (a) => {
      const out: Record<string, unknown> = { sheet: String(a.sheet) };
  ...
  },
  {
    ...
    args: [
      { name: "sheet", flag: "--sheet <name>", kind: "string", required: true, description: "Sheet name." },
      {
        ...
        flag: "--horizontal-centered <bool>",
        kind: "boolean",
        description: "Centre horizontally on page.",
      },
      {
        name: "verticalCentered",
        flag: "--vertical-centered <bool>",
        kind: "boolean",
        description: "Centre vertically on page.",
      },
      {
        name: "headings",
        flag: "--headings <bool>",
        kind: "boolean",
        description: "Print row/column headings.",
      },
      { name: "gridLines", flag: "--grid-lines <bool>", kind: "boolean", description: "Print gridlines." },
      {
        ...
        flag: "--clear",
        kind: "boolean",
        description: "Drop the <printOptions> element entirely.",
      },
    ],
    buildPayload: (a) => {
      const out: Record<string, unknown> = { sheet: String(a.sheet) };
  ...
  },
  {
    ...
    args: [
      { name: "sheet", flag: "--sheet <name>", kind: "string", required: true, description: "Sheet name." },
      {
        ...
        flag: "--rows <range>",
        kind: "string",
        description: "Row range to repeat (e.g. '1:1').",
      },
      {
        name: "cols",
        flag: "--cols <range>",
        kind: "string",
        description: "Column range to repeat (e.g. 'A:B').",
      },
  ...
  },
  {
    ...
    args: [
      ...
      {
        name: "showGridLines",
        flag: "--show-grid-lines <bool>",
        kind: "boolean",
        description: "Show worksheet gridlines.",
      },
      {
        name: "showRowColHeaders",
        flag: "--show-row-col-headers <bool>",
        kind: "boolean",
        description: "Show row & column headings.",
      },
      { name: "showZeros", flag: "--show-zeros <bool>", kind: "boolean", description: "Show zero values." },
      {
        name: "showRuler",
        flag: "--show-ruler <bool>",
        kind: "boolean",
        description: "Show the page ruler (Page Layout view).",
      },
      {
        name: "showOutlineSymbols",
        flag: "--show-outline-symbols <bool>",
        kind: "boolean",
        description: "Show outline-level symbols.",
      },
      {
        name: "rightToLeft",
        flag: "--right-to-left <bool>",
        kind: "boolean",
        description: "Render the sheet right-to-left.",
      },
      { name: "zoomScale", flag: "--zoom-scale <n>", kind: "number", description: "Zoom scale (10–400)." },
      {
        name: "zoomScaleNormal",
        flag: "--zoom-scale-normal <n>",
        kind: "number",
        description: "Zoom scale for the normal view (10–400).",
      },
    ],
    buildPayload: (a) => {
      const out: Record<string, unknown> = { sheet: String(a.sheet) };
