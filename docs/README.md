...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Understand the project at a glance                 | [`../README.md`](../README.md), then [`../prompt.md`](../prompt.md) for the original brief                                                                                                 |
| See where the DOCX track is today                  | [`session-summary.md`](session-summary.md) — phase map (P0 → P3), test counts, what's deferred                                                                                             |
| Read what shipped, in order, with caveats          | [`build-log/docx.md`](build-log/docx.md) — chronological per-batch log (P0 decisions → P3.7), each section: what shipped → decisions → caveats                                             |
| See the XLSX track                                 | [`build-log/xlsx.md`](build-log/xlsx.md)                                                                                                                                                   |
| Understand the cross-cutting CI / quality gates    | [`build-log/quality-gates.md`](build-log/quality-gates.md)                                                                                                                                 |
